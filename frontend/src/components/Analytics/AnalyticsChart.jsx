...
const AnalyticsChart = () => {
  ...
  if (!chartData) return <div className="h-[400px] bg-white dark:bg-[#24303F] rounded-xl border border-stroke dark:border-[#2E3A47] animate-pulse mb-4 md:mb-6 2xl:mb-7.5" />;
