...
const CRMStatistics = () => {
  ...
  const { data, loading, error, fetchData } = useApi('/crm/statistics');
      ...
      <DataState 
        ...
        skeleton={
          <div className="h-full w-full animate-pulse pt-2">
            ...
            <div className="h-[250px] w-full bg-gradient-to-t from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600 rounded opacity-50 mt-4"></div>
          </div>
        }
      >
