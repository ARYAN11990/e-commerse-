...
const EstimatedRevenue = () => {
  const { data, loading, error, fetchData } = useApi('/crm/estimated-revenue');
  ...
  return (
    <div className="rounded-xl border border-stroke dark:border-[#2E3A47] bg-white dark:bg-[#24303F] p-6 shadow-default h-full flex flex-col justify-between">
      <DataState 
        ...
        isEmpty={!data} 
        skeleton={
          <div className="flex flex-col animate-pulse pt-4">
            <div className="h-[200px] w-full flex items-center justify-center">
              <div className="h-[150px] w-[200px] rounded-t-full bg-gray-200 dark:bg-gray-700 mb-8"></div>
            </div>
            <div className="flex flex-col gap-4 mt-8">
              <div className="flex justify-between items-center"><div className="h-4 w-20 bg-gray-200 dark:bg-gray-700 rounded"></div><div className="h-4 w-12 bg-gray-200 dark:bg-gray-700 rounded"></div></div>
              <div className="h-6 w-full bg-gray-200 dark:bg-gray-700 rounded"></div>
              <div className="flex justify-between items-center mt-2"><div className="h-4 w-20 bg-gray-200 dark:bg-gray-700 rounded"></div><div className="h-4 w-12 bg-gray-200 dark:bg-gray-700 rounded"></div></div>
              <div className="h-6 w-full bg-gray-200 dark:bg-gray-700 rounded"></div>
            </div>
          </div>
        }
