...
const MyCards = () => {
  const { data, loading, error, fetchData } = useApi('/finance/cards');
      ...
      <DataState 
        ...
        skeleton={
          <div className="h-full w-full animate-pulse flex flex-col">
            ...
            <div className="relative rounded-2xl bg-gray-200 dark:bg-gray-700 p-6 h-[180px] mb-6"></div>
            <div className="flex justify-between items-center">
              <div className="h-4 w-20 bg-gray-200 dark:bg-gray-700 rounded"></div>
              <div className="flex gap-2"><div className="w-8 h-8 rounded-md bg-gray-200 dark:bg-gray-700"></div><div className="w-8 h-8 rounded-md bg-gray-200 dark:bg-gray-700"></div></div>
            </div>
          </div>
        }
      >
