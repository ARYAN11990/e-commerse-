  ...
  return (
    <div className="rounded-xl border border-stroke dark:border-[#2E3A47] bg-white dark:bg-[#24303F] px-5 pt-6 pb-2.5 shadow-default sm:px-7.5 xl:pb-1">
      ...
      <DataState 
        ...
        skeleton={
          <div className="max-w-full overflow-x-auto border-t border-stroke dark:border-[#2E3A47] pt-2">
            <table className="w-full table-auto animate-pulse">
              <thead>
                <tr className="border-b border-stroke dark:border-[#2E3A47] text-left">
                  <th className="py-4 pl-4"><div className="w-4 h-4 rounded bg-gray-200 dark:bg-gray-700"></div></th>
                  <th className="py-4"><div className="h-4 w-16 bg-gray-200 dark:bg-gray-700 rounded"></div></th>
                  <th className="py-4"><div className="h-4 w-20 bg-gray-200 dark:bg-gray-700 rounded"></div></th>
                  <th className="py-4"><div className="h-4 w-24 bg-gray-200 dark:bg-gray-700 rounded"></div></th>
                  <th className="py-4"><div className="h-4 w-24 bg-gray-200 dark:bg-gray-700 rounded"></div></th>
                  <th className="py-4"><div className="h-4 w-16 bg-gray-200 dark:bg-gray-700 rounded"></div></th>
                  <th className="py-4"><div className="h-4 w-16 bg-gray-200 dark:bg-gray-700 rounded"></div></th>
                  <th className="py-4"><div className="h-4 w-16 bg-gray-200 dark:bg-gray-700 rounded"></div></th>
              ...
              <tbody>
                {[1, 2, 3, 4, 5].map(i => (
                  <tr key={i} className="border-b border-stroke dark:border-[#2E3A47]">
                    <td className="py-4 pl-4"><div className="w-4 h-4 rounded bg-gray-200 dark:bg-gray-700"></div></td>
                    <td className="py-4"><div className="h-4 w-20 bg-gray-200 dark:bg-gray-700 rounded"></div></td>
                    ...
                    <td className="py-4"><div className="h-4 w-16 bg-gray-200 dark:bg-gray-700 rounded"></div></td>
                    <td className="py-4"><div className="h-4 w-20 bg-gray-200 dark:bg-gray-700 rounded"></div></td>
                  </tr>
                ))}
              </tbody>
      ...
      >
        <div className="max-w-full overflow-x-auto border-t border-stroke dark:border-[#2E3A47] pb-4">
