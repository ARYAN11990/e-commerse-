...
const LogisticsKpiCards = () => {
  ...
  if (!kpis.length) return <div className="animate-pulse h-[140px] bg-white dark:bg-[#24303F] rounded-xl border border-stroke dark:border-[#2E3A47] mb-4 md:mb-6 2xl:mb-7.5" />;
